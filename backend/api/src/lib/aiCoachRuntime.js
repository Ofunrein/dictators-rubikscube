  ...
  if (solved) {
    ...
    coachMessage = {
      ...
      content: moves.length > 0
        ? 'Best-effort solve suggestion generated by reversing verified session history.'
        : 'No move history is available to reconstruct a solve sequence.',
      moves,
      nextActions: ['Apply the moves in order', 'Pause after each trigger to confirm orientation'],
