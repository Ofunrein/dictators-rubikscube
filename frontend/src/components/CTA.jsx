/**
 * Call-to-Action section -- the big red banner near the bottom of the landing
 * page that says "Ready to solve?" with a button to launch the simulator.
 * Simple presentational component, no animations or hooks.
 */
