/**
 * Features section of the landing page. Shows off the simulator's capabilities
 * in a grid layout: 3D manipulation, the 18-move engine, step-by-step tutorials,
 * and the REST API. Includes a typing animation that cycles through algorithm
