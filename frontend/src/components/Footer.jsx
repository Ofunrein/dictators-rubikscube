/**
 * Footer at the bottom of the page. Shows the team name, links to the
 * simulator and GitHub repo, and a copyright line. Dark background with a
 * subtle dot pattern and scanline effect to match the site's aesthetic.
 */
