/**
 * Philosophy section -- "Why We Built This". Displays the team's goals and
 * motivation in a three-column grid with floating wireframe cubes in the
 * background. The wireframe cubes slowly rotate using Three.js to add visual
 * depth. Uses GSAP for scroll-triggered fade-in animations.
 */
