/**
 * Protocol section -- shows how to use the API with example endpoints.
 * Displays the REST API routes in a styled list (health check, solved state,
 * apply move, scramble, solve). Includes a 3D wireframe cube animation in the
 * background. Uses GSAP with ScrollTrigger for scroll-based reveal animations.
 */
