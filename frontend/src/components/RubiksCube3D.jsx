/**
 * 3D Rubik's Cube component used on the LANDING PAGE (not the simulator).
 * This is a simplified version that just shows a nice-looking cube with colored
 * stickers that slowly rotates. It doesn't handle user interaction or move
 * animations -- that's InteractiveCube.jsx's job in the simulator. Used in
